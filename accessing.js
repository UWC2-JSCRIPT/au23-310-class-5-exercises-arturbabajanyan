...
const allClassSun = document.querySelectorAll("li.sun");

allClassSun.forEach((element) => {
...
// OR replaces old class with new one
// liList[1].classList.replace('sun', 'cloudy');
// OR erases all classes and puts new one
// liList[1].className = "cloudy";